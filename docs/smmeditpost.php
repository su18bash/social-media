    ...
    if(isset($_SESSION['smm_username']))
    {
      ...
      <ul class="navbar-nav ml-auto">
        <li class="nav-item dropdown">
          <a class="nav-link" href="smmlogout.php"> Logout </a>
        </li>
      </ul>
      <?php
    }
...
<!--       <div class="user-panel mt-3 pb-3 mb-3 d-flex">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="smmnewpost.php" class="nav-link">
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <?php
              if(isset($_GET['s']))
              {
                echo "<script> alert('Post content is updated Successfully'); window.location.href='smmviewposts.php'; </script>";
            ...
            <div class="card card-info">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form class="form-horizontal" method="post"  enctype="multipart/form-data" action="smmpostsubmit.php">
                <div class="card-body">
                  ...
                  <!--<div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="form-control" name="raw_post" value="<?php echo $raw_post; ?>" placeholder="Enter Raw Post">
                    </div>
                  </div>-->
                  
                  <div class="form-group row">
                    <label for="inputEmail3" class="col-sm-4 col-form-label">SMM Comments </label>
                    <div class="col-sm-8">
                      <textarea name="smm_comments" class="form-control" placeholder="Enter SMM Comments here..."></textarea>
                    </div>
                  </div>

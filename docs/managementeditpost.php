...
<?php
  if(!isset($_SESSION['management_username']))
    {
    ...
    if(isset($_SESSION['management_username']))
    {
      ...
      <ul class="navbar-nav ml-auto">
        <li class="nav-item dropdown">
          <a class="nav-link" href="managementlogout.php"> Logout </a>
        </li>
      </ul>
      <?php
    }
...
<!--       <div class="user-panel mt-3 pb-3 mb-3 d-flex">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="managementviewposts.php" class="nav-link active">
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <?php
              if(isset($_GET['s']))
              {
                echo "<script> alert('Post content is updated Successfully'); window.location.href='managementviewposts.php'; </script>";
            ...
            <div class="card card-info">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form class="form-horizontal" method="post"  enctype="multipart/form-data" action="managementpostsubmit.php">
                <div class="card-body">
                  ...
                  <div class="form-group row">
                    <label for="inputEmail3" class="col-sm-4 col-form-label">Management Comments </label>
                    <div class="col-sm-8">
                      <textarea name="management_comments" class="form-control" placeholder="Enter Management Comments here..."></textarea>
                    </div>
                  </div>
